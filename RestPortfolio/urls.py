...
from restapi.views import (MeViewSet, ProjectViewSet, PricingViewSet, SkillViewSet, ContactViewSet)
...
schema_view = get_schema_view(
    openapi.Info(
        ...
        terms_of_service="https://policies.google.com/privacy?hl=ru",
        
        contact = openapi.Contact(
            name= "Xeniya Solovyova",
